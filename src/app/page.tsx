import { ContainerScroll, ContainerScrolll } from "@/components/global/ContainerScoller";
import { InfiniteMovingCards } from "@/components/global/InfiniteMovinf";
...
<ContainerScroll
            titleComponent={<div className=" flex items-center justify-center flex-col">
              ...
              <h1 className=" text-5xl md:text-3xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-600 font-sans font-bold">
                Automate Your Work With BuildoMatic
              </h1>
